#import "tudaexercise.typ": (
  difficulty-format, point-format, subtask, task, task-points-header,
  tuda-gray-info, tudaexercise,
)
...
#import "common/addons/difficulty-points.typ": (
  difficulty-stars as tuda-difficulty-stars,
)
