...
#import "common/headings.typ": tuda-section-lines
...
#let tudapub(
  ...
  if show_pages.affidavit [
    ...
    === § 8 Abs. 1 lit. d PromO
    Ich versichere hiermit, dass zu einem vorherigen Zeitpunkt noch keine
    Promotion versucht wurde. In diesem Fall sind nähere Angaben über Zeitpunkt,
    Hochschule, Dissertationsthema und Ergebnis dieses Versuchs mitzuteilen.

    === § 9 Abs. 1 PromO
    Ich versichere hiermit, dass die vorliegende Dissertation -- abgesehen von
    den in ihr ausdrücklich genannten Hilfen -- selbstständig verfasst wurde und
    dass die "Grundsätze zur Sicherung guter wissenschaftlicher Praxis an der
    Technischen Universität Darmstadt" und die "Leitlinien zum Umgang mit
    digitalen Forschungsdaten an der TU Darmstadt" in den jeweils aktuellen
    Versionen bei der Verfassung der Dissertation beachtet wurden.
    ...
    #table(
      ...
      [
        #location,
        #format-date(date_of_submission, "de")
      ],
      align(right)[
        #stack(
